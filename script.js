...
function showMagnaCumlaudeImage(){
    document.getElementById('popupMagnaCumlaudeImage').style.display = "flex";
    document.getElementById('headerHide').style.zIndex = -1;
}

function closePopupMagnaCumlaude(){
    document.getElementById('popupMagnaCumlaudeImage').style.display = "none";
    document.getElementById('headerHide').style.zIndex = 1;
}
...
function showCertifSQLImage(){
    document.getElementById('popupCertifSQLImage').style.display = "flex";
    document.getElementById('headerHide').style.zIndex = -1;
}

function closePopupCertifSQL(){
    document.getElementById('popupCertifSQLImage').style.display = "none";
    document.getElementById('headerHide').style.zIndex = 1;
}

function showCertifCplusImage(){
    document.getElementById('popupCertifCplusImage').style.display = "flex";
    document.getElementById('headerHide').style.zIndex = -1;
}

function closePopupCertifCplus(){
    document.getElementById('popupCertifCplusImage').style.display = "none";
    document.getElementById('headerHide').style.zIndex = 1;
}

function showCertifPublicSpeakingImage(){
    document.getElementById('popupCertifPublicSpeakingImage').style.display = "flex";
    document.getElementById('headerHide').style.zIndex = -1;
}

function closePopupCertifPublicSpeaking(){
    document.getElementById('popupCertifPublicSpeakingImage').style.display = "none";
    document.getElementById('headerHide').style.zIndex = 1;
}

function showCertifFrontEndImage(){
    document.getElementById('popupCertifFrontEndImage').style.display = "flex";
    document.getElementById('headerHide').style.zIndex = -1;
}

function closePopupCertifFrontEnd(){
    document.getElementById('popupCertifFrontEndImage').style.display = "none";
    document.getElementById('headerHide').style.zIndex = 1;
}
